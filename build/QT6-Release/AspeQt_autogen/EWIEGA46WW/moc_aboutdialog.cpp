...
static constexpr auto qt_meta_stringdata_ZN11AboutDialogE = QtMocHelpers::stringData(
    "AboutDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11AboutDialogE[] = {
...
Q_CONSTINIT const QMetaObject AboutDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11AboutDialogE.offsetsAndSizes,
    qt_meta_data_ZN11AboutDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11AboutDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *AboutDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11AboutDialogE.stringdata0))

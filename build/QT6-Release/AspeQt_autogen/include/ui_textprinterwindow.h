...
public:
    ...
    void setupUi(QMainWindow *TextPrinterWindow)
    {
        if (TextPrinterWindow->objectName().isEmpty())
            TextPrinterWindow->setObjectName("TextPrinterWindow");
        TextPrinterWindow->resize(666, 437);
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icons/silk-icons/icons/printer.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        TextPrinterWindow->setWindowIcon(icon);
        actionSave = new QAction(TextPrinterWindow);
        actionSave->setObjectName("actionSave");
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/silk-icons/icons/disk.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionSave->setIcon(icon1);
        actionClear = new QAction(TextPrinterWindow);
        actionClear->setObjectName("actionClear");
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/silk-icons/icons/page_white.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icons/silk-icons/icons/text_align_left.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        actionAtasciiFont->setObjectName("actionAtasciiFont");
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icons/silk-icons/icons/font_go.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        icon4.addFile(QString::fromUtf8(":/icons/silk-icons/icons/font_go.png"), QSize(), QIcon::Mode::Normal, QIcon::State::On);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icons/oxygen-icons/16x16/actions/format_font_size_more.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        icon5.addFile(QString::fromUtf8(":/icons/oxygen-icons/16x16/actions/format_font_size_more.png"), QSize(), QIcon::Mode::Normal, QIcon::State::On);
        actionFont_Size->setIcon(icon5);
        actionFont_Size->setVisible(true);
        actionHideShow_Ascii = new QAction(TextPrinterWindow);
        actionHideShow_Ascii->setObjectName("actionHideShow_Ascii");
        actionHideShow_Ascii->setCheckable(true);
        actionHideShow_Ascii->setChecked(false);
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/icons/oxygen-icons/16x16/actions/view_right_close.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        icon6.addFile(QString::fromUtf8(":/icons/oxygen-icons/16x16/actions/view_right_close.png"), QSize(), QIcon::Mode::Normal, QIcon::State::On);
        ...
        actionHideShow_Atascii->setObjectName("actionHideShow_Atascii");
        actionHideShow_Atascii->setCheckable(true);
        actionHideShow_Atascii->setChecked(false);
        actionHideShow_Atascii->setEnabled(true);
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/icons/oxygen-icons/16x16/actions/view_left_close.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        icon7.addFile(QString::fromUtf8(":/icons/oxygen-icons/16x16/actions/view_left_close.png"), QSize(), QIcon::Mode::Normal, QIcon::State::On);
        ...
        actionStrip_Line_Numbers->setObjectName("actionStrip_Line_Numbers");
        actionStrip_Line_Numbers->setEnabled(true);
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/icons/silk-icons/icons/cut_red.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        printerTextEdit->setObjectName("printerTextEdit");
        ...
        printerTextEditASCII->setObjectName("printerTextEditASCII");
        ...
        atasciiFontName->setObjectName("atasciiFontName");
        ...
        asciiFontName->setObjectName("asciiFontName");
        QFont font1;
        ...
        TextPrinterWindow->addToolBar(Qt::ToolBarArea::TopToolBarArea, toolBar);

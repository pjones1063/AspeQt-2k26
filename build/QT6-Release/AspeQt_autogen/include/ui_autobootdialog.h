...
public:
    ...
    void setupUi(QDialog *AutoBootDialog)
    {
        if (AutoBootDialog->objectName().isEmpty())
            AutoBootDialog->setObjectName("AutoBootDialog");
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, AutoBootDialog, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, AutoBootDialog, qOverload<>(&QDialog::reject));

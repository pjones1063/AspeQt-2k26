...
public:
    ...
    void setupUi(QFrame *DriveWidget)
    {
        if (DriveWidget->objectName().isEmpty())
            DriveWidget->setObjectName("DriveWidget");
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icons/silk-icons/icons/disk.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionMountDisk->setIcon(icon);
        actionMountFolder = new QAction(DriveWidget);
        actionMountFolder->setObjectName("actionMountFolder");
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/silk-icons/icons/folder.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionMountFolder->setIcon(icon1);
        actionEject = new QAction(DriveWidget);
        actionEject->setObjectName("actionEject");
        actionEject->setEnabled(false);
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/silk-icons/icons/control_eject.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionEject->setIcon(icon2);
        actionWriteProtect = new QAction(DriveWidget);
        actionWriteProtect->setObjectName("actionWriteProtect");
        actionWriteProtect->setCheckable(true);
        actionWriteProtect->setEnabled(false);
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icons/silk-icons/icons/lock_open.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        icon3.addFile(QString::fromUtf8(":/icons/silk-icons/icons/lock.png"), QSize(), QIcon::Mode::Normal, QIcon::State::On);
        actionWriteProtect->setIcon(icon3);
        actionEditDisk = new QAction(DriveWidget);
        actionEditDisk->setObjectName("actionEditDisk");
        actionEditDisk->setCheckable(true);
        actionEditDisk->setEnabled(false);
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icons/silk-icons/icons/folder_edit.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionEditDisk->setIcon(icon4);
        actionSave = new QAction(DriveWidget);
        actionSave->setObjectName("actionSave");
        actionSave->setEnabled(false);
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icons/silk-icons/icons/drive_disk.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/icons/silk-icons/icons/arrow_undo.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionRevert->setIcon(icon6);
        actionSaveAs = new QAction(DriveWidget);
        actionSaveAs->setObjectName("actionSaveAs");
        actionSaveAs->setEnabled(false);
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/icons/silk-icons/icons/drive_rename.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/icons/silk-icons/icons/drive_go.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionAutoSave->setIcon(icon8);
        actionBootOption = new QAction(DriveWidget);
        actionBootOption->setObjectName("actionBootOption");
        actionBootOption->setEnabled(false);
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/icons/oxygen-icons/16x16/actions/flag_green.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        buttonMountDisk->setObjectName("buttonMountDisk");
        ...
        buttonMountFolder->setObjectName("buttonMountFolder");
        ...
        buttonEditDisk->setObjectName("buttonEditDisk");
        ...
        labelImageProperties->setObjectName("labelImageProperties");
        ...
        buttonEject->setObjectName("buttonEject");

...
public:
    ...
    void setupUi(QDialog *LogDisplayDialog)
    {
        if (LogDisplayDialog->objectName().isEmpty())
            LogDisplayDialog->setObjectName("LogDisplayDialog");
        ...
        listByDisk->addItem(QString());
        listByDisk->addItem(QString());
        listByDisk->setObjectName("listByDisk");
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::clicked, LogDisplayDialog, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::clicked, LogDisplayDialog, qOverload<>(&QDialog::reject));
        QObject::connect(listByDisk, &QComboBox::currentIndexChanged, LogDisplayDialog, qOverload<>(&QDialog::repaint));

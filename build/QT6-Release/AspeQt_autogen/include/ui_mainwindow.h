...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icons/main-icon/AspeQt.ico"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        MainWindow->setWindowIcon(icon);
        MainWindow->setStyleSheet(QString::fromUtf8(""));
        MainWindow->setLocale(QLocale(QLocale::English, QLocale::UnitedStates));
        MainWindow->setIconSize(QSize(24, 24));
        actionEjectAll = new QAction(MainWindow);
        actionEjectAll->setObjectName("actionEjectAll");
        actionEjectAll->setCheckable(false);
        actionEjectAll->setEnabled(true);
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/silk-icons/icons/control_eject.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionEjectAll->setIcon(icon1);
        actionEjectAll->setIconVisibleInMenu(true);
        actionOptions = new QAction(MainWindow);
        actionOptions->setObjectName("actionOptions");
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/other-icons/run.ico"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionOptions->setIcon(icon2);
        actionStartEmulation = new QAction(MainWindow);
        actionStartEmulation->setObjectName("actionStartEmulation");
        actionStartEmulation->setCheckable(true);
        actionStartEmulation->setChecked(false);
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icons/silk-icons/icons/disconnect.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        icon3.addFile(QString::fromUtf8(":/icons/silk-icons/icons/connect.png"), QSize(), QIcon::Mode::Normal, QIcon::State::On);
        ...
        actionMountRecent_0->setObjectName("actionMountRecent_0");
        actionMountRecent_0->setText(QString::fromUtf8(""));
        actionMountDisk = new QAction(MainWindow);
        actionMountDisk->setObjectName("actionMountDisk");
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icons/oxygen-icons/16x16/devices/3floppy_unmount.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionMountDisk->setIcon(icon4);
        actionMountFolder = new QAction(MainWindow);
        actionMountFolder->setObjectName("actionMountFolder");
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icons/silk-icons/icons/folder.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionMountFolder->setIcon(icon5);
        actionNewImage = new QAction(MainWindow);
        actionNewImage->setObjectName("actionNewImage");
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/icons/oxygen-icons/16x16/devices/media_floppy.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/icons/silk-icons/icons/monitor_go.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionSaveSession->setIcon(icon7);
        actionOpenSession = new QAction(MainWindow);
        actionOpenSession->setObjectName("actionOpenSession");
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/icons/silk-icons/icons/monitor.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionOpenSession->setIcon(icon8);
        actionBootExe = new QAction(MainWindow);
        actionBootExe->setObjectName("actionBootExe");
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/icons/Atari.ico"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        actionSave_1->setObjectName("actionSave_1");
        actionSave_1->setEnabled(false);
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/icons/silk-icons/icons/drive_disk.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionSave_1->setIcon(icon10);
        actionShowPrinterTextOutput = new QAction(MainWindow);
        actionShowPrinterTextOutput->setObjectName("actionShowPrinterTextOutput");
        actionShowPrinterTextOutput->setCheckable(true);
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/icons/oxygen-icons/16x16/devices/printer1.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionShowPrinterTextOutput->setIcon(icon11);
        actionPlaybackCassette = new QAction(MainWindow);
        actionPlaybackCassette->setObjectName("actionPlaybackCassette");
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/icons/oxygen-icons/16x16/devices/media_tape.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionPlaybackCassette->setIcon(icon12);
        actionQuit = new QAction(MainWindow);
        actionQuit->setObjectName("actionQuit");
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/icons/oxygen-icons/16x16/actions/exit.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionQuit->setIcon(icon13);
        actionAbout = new QAction(MainWindow);
        actionAbout->setObjectName("actionAbout");
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/icons/oxygen-icons/16x16/actions/help_about.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon15;
        icon15.addFile(QString::fromUtf8(":/icons/oxygen-icons/16x16/actions/help_contents.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionDocumentation->setIcon(icon15);
        actionDefaultImageGroup = new QAction(MainWindow);
        actionDefaultImageGroup->setObjectName("actionDefaultImageGroup");
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/icons/oxygen-icons/16x16/actions/document_save_all.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionDefaultImageGroup->setIcon(icon16);
        actionPrinterEmulation = new QAction(MainWindow);
        actionPrinterEmulation->setObjectName("actionPrinterEmulation");
        actionPrinterEmulation->setCheckable(false);
        actionPrinterEmulation->setChecked(false);
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/icons/silk-icons/icons/printer.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionPrinterEmulation->setIcon(icon17);
        actionHideShowDrives = new QAction(MainWindow);
        actionHideShowDrives->setObjectName("actionHideShowDrives");
        QIcon icon18;
        icon18.addFile(QString::fromUtf8(":/icons/silk-icons/icons/drive_add.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionHideShowDrives->setIcon(icon18);
        actionToggleMiniMode = new QAction(MainWindow);
        actionToggleMiniMode->setObjectName("actionToggleMiniMode");
        QIcon icon19;
        icon19.addFile(QString::fromUtf8(":/icons/other-icons/MiniCooper 22.ico"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionToggleMiniMode->setIcon(icon19);
        actionToggleShade = new QAction(MainWindow);
        actionToggleShade->setObjectName("actionToggleShade");
        actionToggleShade->setEnabled(false);
        QIcon icon20;
        icon20.addFile(QString::fromUtf8(":/icons/other-icons/fade.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionToggleShade->setIcon(icon20);
        actionLogWindow = new QAction(MainWindow);
        actionLogWindow->setObjectName("actionLogWindow");
        QIcon icon21;
        icon21.addFile(QString::fromUtf8(":/icons/silk-icons/icons/page_white_text.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        menu_Disk->setObjectName("menu_Disk");

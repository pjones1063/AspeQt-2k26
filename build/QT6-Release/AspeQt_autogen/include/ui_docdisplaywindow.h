...
public:
    ...
    void setupUi(QMainWindow *DocDisplayWindow)
    {
        if (DocDisplayWindow->objectName().isEmpty())
            DocDisplayWindow->setObjectName("DocDisplayWindow");
        DocDisplayWindow->setWindowModality(Qt::NonModal);
        DocDisplayWindow->resize(640, 480);
        QIcon icon;
        icon.addFile(QString::fromUtf8("silk-icons/icons/report.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        DocDisplayWindow->setWindowIcon(icon);
        actionPrint = new QAction(DocDisplayWindow);
        actionPrint->setObjectName("actionPrint");
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/silk-icons/icons/printer.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        docDisplay->setObjectName("docDisplay");
        ...
        DocDisplayWindow->addToolBar(Qt::ToolBarArea::TopToolBarArea, toolBar);

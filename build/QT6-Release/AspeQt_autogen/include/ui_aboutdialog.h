...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        respeqtLabel->setObjectName("respeqtLabel");
        QFont font;
        font.setBold(true);
        respeqtLabel->setFont(font);
        respeqtLabel->setLocale(QLocale(QLocale::English, QLocale::UnitedStates));
        respeqtLabel->setTextFormat(Qt::AutoText);
        respeqtLabel->setScaledContents(true);
    ...
    void retranslateUi(QDialog *AboutDialog)
    {
        ...
        respeqtLabel->setText(QCoreApplication::translate("AboutDialog", "AspeQt 2k26: Atari Serial Peripheral Emulator for Qt", nullptr));

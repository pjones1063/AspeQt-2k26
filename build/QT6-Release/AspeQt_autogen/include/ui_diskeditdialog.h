...
public:
    ...
    void setupUi(QMainWindow *DiskEditDialog)
    {
        if (DiskEditDialog->objectName().isEmpty())
            DiskEditDialog->setObjectName("DiskEditDialog");
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icons/silk-icons/icons/folder_edit.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        DiskEditDialog->setWindowIcon(icon);
        actionToParent = new QAction(DiskEditDialog);
        actionToParent->setObjectName("actionToParent");
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/silk-icons/icons/arrow_up.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionToParent->setIcon(icon1);
        actionAddFiles = new QAction(DiskEditDialog);
        actionAddFiles->setObjectName("actionAddFiles");
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/silk-icons/icons/add.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionAddFiles->setIcon(icon2);
        actionExtractFiles = new QAction(DiskEditDialog);
        actionExtractFiles->setObjectName("actionExtractFiles");
        actionExtractFiles->setEnabled(false);
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icons/silk-icons/icons/page_white_go.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionExtractFiles->setIcon(icon3);
        actionTextConversion = new QAction(DiskEditDialog);
        actionTextConversion->setObjectName("actionTextConversion");
        actionTextConversion->setCheckable(true);
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icons/silk-icons/icons/page_white_text.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionTextConversion->setIcon(icon4);
        actionDeleteSelectedFiles = new QAction(DiskEditDialog);
        actionDeleteSelectedFiles->setObjectName("actionDeleteSelectedFiles");
        actionDeleteSelectedFiles->setEnabled(false);
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icons/silk-icons/icons/delete.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionDeleteSelectedFiles->setIcon(icon5);
        actionPrint = new QAction(DiskEditDialog);
        actionPrint->setObjectName("actionPrint");
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/icons/silk-icons/icons/printer.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        onTopBox->setObjectName("onTopBox");
        ...
        DiskEditDialog->addToolBar(Qt::ToolBarArea::TopToolBarArea, toolBar);

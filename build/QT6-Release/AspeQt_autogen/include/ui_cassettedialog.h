...
public:
    ...
    void setupUi(QDialog *CassetteDialog)
    {
        if (CassetteDialog->objectName().isEmpty())
            CassetteDialog->setObjectName("CassetteDialog");
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, CassetteDialog, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, CassetteDialog, qOverload<>(&QDialog::reject));

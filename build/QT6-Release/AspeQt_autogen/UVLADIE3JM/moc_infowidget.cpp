...
static constexpr auto qt_meta_stringdata_ZN10InfoWidgetE = QtMocHelpers::stringData(
    "InfoWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10InfoWidgetE[] = {
...
Q_CONSTINIT const QMetaObject InfoWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10InfoWidgetE.offsetsAndSizes,
    qt_meta_data_ZN10InfoWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10InfoWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *InfoWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10InfoWidgetE.stringdata0))
